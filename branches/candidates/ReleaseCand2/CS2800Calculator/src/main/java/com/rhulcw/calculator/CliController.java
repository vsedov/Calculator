...
public class CliController {
    ...
    switch (option) {
      ...
      default:
        ...
        try {
          ...
          System.out.println(CalcModel.postFixEvaluation(postFixVal));
          break;
      ...
      case (2):
        ...
        try {
          System.out.println(CalcModel.inFixEvaluation(inFixVal));
          break;
  ...
  private static int outputMenue(Scanner input) throws EmptyStackException {
    System.out.println("psstt there is a hidden Easter Egg\n");
  ...
  public static void main(String[] args) throws Exception {
    ...
    int outputController = CliController.outputMenue(input);

    if (outputController == -1 || outputController == 0) {
      Driver.main(args);
    }
  }

  /**
   * Easter egg, this was just for fun, better user interaction.
   */
  public static void easterEgg() {
    System.out.println("WOW good job you have managed to enter the easter egg numbers");
    System.out.println(
