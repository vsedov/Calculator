...
public class CliController {
  ...
  /**
   * Launch gui. // Not been made yet .
   */
  public static void launchGui() {
    // TODO GUI WILL BE MADE IN NEXT RELEASE
  }
   ...
   */
  private static void outputMenue(Scanner input) throws EmptyStackException {
  ...
  public static void main(String[] args) {
    ...
    CliController.outputMenue(input);
  }
}
